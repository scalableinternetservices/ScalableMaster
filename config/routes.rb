Rails.application.routes.draw do
  ...
  get '/organizers/:id/activities/:activity_id' => 'organizers/activities#edit', as: :organizer_activity
  patch '/organizers/:id/activities/:activity_id' => 'organizers/activities#update'
  put '/organizers/:id/activities/:activity_id' => 'organizers/activities#update'
